...
/**
 * @file PolynomialCell.hpp
 * Cell dedicated to polynomial operation.
 */
...
namespace Systolic {
	namespace Cell {
		 ...
		 * Cell that performs Horner's method computation.
		 */
		class PolynomialCell : public ICell {
		public:
			/**
			 * Default constructor.
			 */
			PolynomialCell(const int coef);

			/**
			 * Perform the computation.
			 * Does Horner's method polynomial evaluation on its 
			 * internal input.
		...
		private:
			const int coef; /** Coefficient of the Horner's method operation. */
